...
class EditApartment extends Component {
  ...
  componentDidMount() {
    ...
    getApartment(id).then(apartment => {
  ...
  onSubmit = e => {
    e.preventDefault();
    editApartment(this.state.apartment).then(() => {
  ...
  deleteApt = () => {
    editApartment(this.state.apartment).then(() => {
      destroyApartment(this.props.match.params.id).then(() => {
        this.setState({ editSuccess: true });
        this.props.refresh();
      });
    });
      ...
      return (
        <div>
            ...
            <fieldset>
              ...
              <div style={group} className="form-group">
                ...
                <input
                  ...
                  value={apartment.building_manager}
                />
              </div>
          ...
          {this.state.editSuccess && (
            <Redirect
              to={`/users/${this.state.apartment.user_id}/apartments`}
            />
          )}
        </div>
      );
